...
class Sydney_Contact_Info extends WP_Widget {
	...
	function form($instance) {
		...
		$cellphone    = isset( $instance['cellphone'] ) ? esc_html( $instance['cellphone'] ) : '';
	...
	<p><label for="<?php echo $this->get_field_id( 'cellphone' ); ?>"><?php _e( 'Enter your cellphone number', 'sydney' ); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id( 'cellphone' ); ?>" name="<?php echo $this->get_field_name( 'cellphone' ); ?>" type="text" value="<?php echo $cellphone; ?>" size="3" /></p>
	...
	function widget($args, $instance) {
		...
		if( ($cellphone) ) {
			echo '<div class="contact-cellphone">';
			echo '<span><i class=" fa-mobile-phone"></i></span>' . $cellphone;
			echo '</div>';
		}
		if( ($email) ) {
