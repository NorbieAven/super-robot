...
var theme_options = $("#optionsframework > form").serializeObject(),themeOptions = theme_options[onetone_admin_params.option_name];
...
$(document).on('click','#onetone-save-options,#optionsframework-submit input[name="update"]',function(e){
			...
			e.preventDefault();
			 ...
			 var formOptions  = $("#optionsframework > form").serializeObject();
